<template>
    <div class="vendorPage">
        <div class="container">
            <h4 class="py-4 m-0" style="font-weight: bold;">STAFF MANAGEMENT</h4>
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="table mt-3">
                        <div class="card px-3">
                            <div class="card-title py-3 d-flex justify-content-between align-items-center">
                                <h5 class="m-0 p-0">Staff List</h5>
                                <button class="btn btn-primary" @click="openEditModal('add')">Add Staff</button>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="saveVendor">
                            <div class="mb-3">
                                <label for="vendorName" class="form-label">Staff Name</label>
        ...
        <div class="modal fade" id="deleteVendorModal" tabindex="-1" aria-labelledby="deleteVendorModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteVendorModalLabel">Delete Staff</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>Are you sure you want to delete this Staff {{ '(' + selectedVendor.vendorName + ')' }}</p>
